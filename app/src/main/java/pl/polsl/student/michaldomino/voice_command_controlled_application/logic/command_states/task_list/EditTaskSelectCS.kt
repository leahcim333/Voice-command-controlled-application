...
class EditTaskSelectCS(override val presenter: TaskListPresenter) : CSNode(presenter) {

    override val messageToSpeakId: Int = R.string.select_task

    override val commandNameId: Int? = R.string.edit_task
    ...
    override fun processInput(userInput: String) {
        ...
        if (mostSimilar != null && selectedItem.similarTo(mostSimilar.text)) {
            val nextState = EditTaskChangeCS(presenter, mostSimilar)
