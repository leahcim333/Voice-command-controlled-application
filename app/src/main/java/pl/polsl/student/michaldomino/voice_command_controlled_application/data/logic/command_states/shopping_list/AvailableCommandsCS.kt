...
class AvailableCommandsCS(override val presenter: ShoppingListPresenter) : CSLeaf(presenter) {
    ...
    override val commandNameId: Int? = ShoppingListCommandsModel.AVAILABLE_COMMANDS_COMMAND

    override fun initialize() {
        val availableCommands: MutableList<Int> = ShoppingListCommandsModel.availableCommands
