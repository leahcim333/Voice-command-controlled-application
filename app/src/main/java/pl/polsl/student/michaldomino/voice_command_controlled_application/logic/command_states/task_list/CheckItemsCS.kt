...
class CheckItemsCS(override val presenter: TaskListPresenter) : CSNode(presenter) {

    override val messageToSpeakId: Int = R.string.list_items

    override val commandNameId: Int? = R.string.check_items

    override fun processInput(userInput: String) {
        presenter.checkItems(userInput)
    }
}