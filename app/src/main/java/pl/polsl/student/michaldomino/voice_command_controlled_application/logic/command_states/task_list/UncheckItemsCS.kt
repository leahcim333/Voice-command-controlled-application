...
class UncheckItemsCS(override val presenter: TaskListPresenter) : CSNode(presenter) {

    override val messageToSpeakId: Int = R.string.list_items

    override val commandNameId: Int? = R.string.uncheck_items

    override fun processInput(userInput: String) {
        presenter.uncheckItems(userInput)
    }
}