...
class ListCheckedItemsCS(override val presenter: TaskListPresenter) : CSLeaf(presenter) {

    override val commandNameId: Int? = R.string.list_checked_items

    override fun initialize() {
        presenter.listCheckedItems()
    }
}