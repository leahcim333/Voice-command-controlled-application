package pl.polsl.student.michaldomino.voice_command_controlled_application.data.logic.command_states.text_note
...
import pl.polsl.student.michaldomino.voice_command_controlled_application.data.logic.command_states.text_note.model.TextNoteCommandsModel
...
class AddTextCS(override val presenter: TextNotePresenter) : CSNode(presenter) {
    ...
    override val commandNameId: Int? = TextNoteCommandsModel.ADD_TEXT
